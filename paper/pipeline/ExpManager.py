import torch
from paper.utils.utils import set_seed
from paper.utils.logger import Logger
import os
import pandas as pd
from paper.data.dataset import Dataset
from paper.pipeline.gnnsolver import GCNSolver, SGCSolver, MLPSolver, LINKXSolver, LINKSolver, APPNPSolver, JKNetSolver, \
    GPRGNNSolver, LPASolver, GATSolver
from paper.pipeline.gslsolver import GRCNSolver, GAUGSolver, GENSolver, IDGLSolver, PROGNNSolver, GTSolver, SLAPSSolver, \
    NODEFORMERSolver, SEGSLSolver, SUBLIMESolver, STABLESolver, CoGSLSolver
import argparse
import wandb
