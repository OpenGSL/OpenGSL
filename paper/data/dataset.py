import torch
from paper.data.pyg_load import pyg_load_dataset
from paper.data.hetero_load import hetero_load
from paper.data.split import get_split
from paper.utils.utils import normalize_feats
import numpy as np
from paper.data.homophily_control import get_new_adj
import pickle
