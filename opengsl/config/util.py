...
def load_conf(path:str = None, method:str = None, dataset:str = None):
    ...
    if path == None:
        ...
        data_name = ['cora', 'pubmed', 'citeseer','blogcatalog', 'flickr', 'amazon-ratings', 'questions', 
                     'minesweeper', 'roman-empire', 'wiki-cooc', 'wikics', 'ogbn-arxiv', 'csbm20', 'csbm40', 'csbm60', 'csbm80']
