...
if __name__ == '__main__':
    ...
    parser.add_argument('--solver', type=str, default='gcn',
                        choices=['gcndense', 'appnp', 'gt', 'gat', 'prognn', 'gen', 'gaug', 'idgl', 'grcn', 'nedgsl-p', 'grcn_plus'], help="The version of solver")
    ...
    parser.add_argument('--not_norm_feats', action='store_true')
